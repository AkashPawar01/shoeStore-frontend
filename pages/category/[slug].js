            ...
            <Wrapper>
                ...
                {data?.meta?.pagination?.total > maxResult && (
                    <div className="flex gap-3 items-center justify-center my-16 md:my-0">
                        <button
                            className={`rounded py-2 px-4 bg-black transition-all duration-150 hover:bg-green-700 text-white disabled:bg-gray-200 disabled:text-gray-500`}
                        ...
                        <button
                            className={`rounded py-2 px-4 bg-black text-white disabled:bg-gray-200 disabled:text-gray-500 transition-all duration-150 hover:bg-green-700 `}
                            disabled={
                                pageIndex ===
